...
- The bin/ directory contains compiled class files generated by Eclipse.
- The movie dataset (movies.txt) is not included in this repository.
- Create your own file following the format described above.
- The application reads movies.txt from the project root directory by default.
- You can modify the path in MovieRecommenderUI.java if needed.
